...
from . import settings_handlers as settings_h
...
"""
    ...
    # ========== Generation Handler ==========
    for trigger in [generation_section["autosave_outputs"], generation_section["autosave_dir"]]:
        trigger.change(
            fn=settings_h.save_generation_settings,
            inputs=[generation_section["autosave_outputs"], generation_section["autosave_dir"]],
            outputs=[generation_section["ui_settings_state"]],
        )
    ...
    generation_section["generate_btn"].click(
        ...
        inputs=[
            ...
            generation_section["autosave_dir"],
            generation_section["lm_temperature"],
            generation_section["cache_src_audio"],
            generation_section["think_checkbox"],
            generation_section["lm_cfg_scale"],
            generation_section["lm_top_k"],
            generation_section["lm_top_p"],
...
def setup_training_event_handlers(demo, dit_handler, llm_handler, training_section):
    ...
    # Reset lyrics from .txt file
    training_section["reset_lyrics_btn"].click(
        fn=train_h.reset_lyrics_from_txt,
        inputs=[
            training_section["sample_selector"],
            training_section["dataset_builder_state"],
        ],
    ...
    training_section["start_training_btn"].click(
        ...
        inputs=[
            ...
            training_section["training_source"],
            training_section["raw_audio_dir"],
            ...
            training_section["prefetch_factor"],
            training_section["persistent_workers"],
            training_section["pin_memory"],
            training_section["matmul_precision"],
            training_section["allow_tf32"],
